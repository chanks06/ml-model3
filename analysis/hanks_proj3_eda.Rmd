...
```
The addition of other 4 components did not significance increase performance of logistic regression. This confirms that we bring along PC1 as we build our predictive model. 
